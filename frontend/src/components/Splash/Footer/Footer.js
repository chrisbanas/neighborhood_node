        ...
        <div className="sub-footer-container">
          ...
          <div className="copyright">
            ...
            <div className="splash-footer-logo-containers">
              <a href="https://www.linkedin.com/in/christopher-banas/" className="splash-footer-linkedin-logo">
                <img src={linkedin} className="splash-footer-portfolio-logo" alt="LinkedIn logo" />
              </a>
              <a href="https://github.com/chrisbanas/neighborhood_node" className="news-feed-nav-bar-github-logo">
                <img src={github} className="splash-footer-portfolio-logo" alt="Github logo" />
              </a>
            </div>
          </div>
        </div>
